...
public class BookingController {
    ...
    @PostMapping
    public BookingWithStatusDto create(@RequestHeader("X-Sharer-User-Id") Long bookerId,
                                       @Valid @RequestBody BookingDto bookingDto) {
        return bookingService.create(bookerId, bookingDto);
    }

    @PatchMapping("{bookingId}")
    public BookingWithStatusDto approve(@RequestHeader("X-Sharer-User-Id") Long ownerId,
    ...
    public BookingWithStatusDto getBooking(@RequestHeader("X-Sharer-User-Id") Long userId,
                                           @PathVariable Long bookingId) {
