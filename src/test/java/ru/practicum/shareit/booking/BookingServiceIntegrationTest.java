...
class BookingServiceIntegrationTest {
    ...
    public void whenGetByBookerId_thenReturnBookingsByBooker() {
        ...
        List<Item> items
                = List.of(createItem(1L, owner), createItem(2L, owner), createItem(3L, owner));
        ...
        assertThat(bookerItems.get(0).getBooker().getId(), equalTo(bookers.get(0).getId()));
        assertThat(bookerItems.get(1).getBooker().getId(), equalTo(bookers.get(0).getId()));
    }
